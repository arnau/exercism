...
var _exercism$xelm$Pangram$toSet = function (str) {
	return _elm_lang$core$Set$fromList(
		_elm_lang$core$String$toList(str));
};
var _exercism$xelm$Pangram$alphabet = _exercism$xelm$Pangram$toSet('abcdefghijklmnopqrstuvwxyz');
