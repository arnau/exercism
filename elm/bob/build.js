...
var _exercism$xelm$Bob$isQuestion = function (text) {
	return A2(_elm_lang$core$String$endsWith, '?', text);
};
var _exercism$xelm$Bob$isYelling = function (text) {
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$String$toUpper(text),
		text) && (!_elm_lang$core$Native_Utils.eq(
		_elm_lang$core$String$toLower(text),
		text));
};
var _exercism$xelm$Bob$isNonsense = function (text) {
	return _elm_lang$core$String$isEmpty(
		_elm_lang$core$String$trim(text));
};
var _exercism$xelm$Bob$Anything = {ctor: 'Anything'};
var _exercism$xelm$Bob$Nonsense = {ctor: 'Nonsense'};
var _exercism$xelm$Bob$Yell = {ctor: 'Yell'};
var _exercism$xelm$Bob$Question = {ctor: 'Question'};
var _exercism$xelm$Bob$toInteraction = function (text) {
	return _exercism$xelm$Bob$isNonsense(text) ? _exercism$xelm$Bob$Nonsense : (_exercism$xelm$Bob$isYelling(text) ? _exercism$xelm$Bob$Yell : (_exercism$xelm$Bob$isQuestion(text) ? _exercism$xelm$Bob$Question : _exercism$xelm$Bob$Anything));
};
var _exercism$xelm$Bob$hey = function (text) {
	var _p0 = _exercism$xelm$Bob$toInteraction(text);
	switch (_p0.ctor) {
		case 'Question':
			return 'Sure.';
		case 'Yell':
