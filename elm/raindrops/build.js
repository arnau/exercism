...
var _exercism$xelm$Raindrops$isFactorOf = F2(
	function (n, _p0) {
		var _p1 = _p0;
		return _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Basics_ops['%'], n, _p1._0),
			0) ? _elm_lang$core$Maybe$Just(_p1._1) : _elm_lang$core$Maybe$Nothing;
	});
var _exercism$xelm$Raindrops$droplets = _elm_lang$core$Native_List.fromArray(
	[
...
var _exercism$xelm$Raindrops$raindrops = function (n) {
	var _p2 = A2(
		...
		_exercism$xelm$Raindrops$isFactorOf(n),
		_exercism$xelm$Raindrops$droplets);
	if (_p2.ctor === '[]') {
		return _elm_lang$core$Basics$toString(n);
	} else {
		return _elm_lang$core$String$concat(_p2);
	}
};
